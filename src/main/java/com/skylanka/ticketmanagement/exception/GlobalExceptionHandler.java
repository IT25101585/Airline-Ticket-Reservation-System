...
/**
 * Centralised exception handler — translates exceptions into consistent JSON responses.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidation(
        ...
        return ResponseEntity.badRequest()
                .body(new ApiResponse<>(false, "Validation failed", "VALIDATION_ERROR", errors));
    }
